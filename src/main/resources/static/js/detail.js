document.addEventListener("DOMContentLoaded", function () {
  ...
  function renderDetail(item) {
    ...
    content.innerHTML = '' +
      ...
      '      <button type="button" class="btn btn-outline-danger js-publication-delete" data-id="' + window.AppLayout.escapeHtml(window.AppLayout.getId(item)) + '"><i class="bi bi-trash me-1"></i>Delete publication</button>' +
      "    </div>" +
      "  </div>" +
      "</div>";
  }
